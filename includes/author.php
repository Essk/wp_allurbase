<?php 
function aub_create_author() {

	$labels = array(
		'name'                  => _x( 'Authors', 'Post Type General Name', 'allurbase' ),
		'singular_name'         => _x( 'Author', 'Post Type Singular Name', 'allurbase' ),
		'menu_name'             => __( 'Authors', 'allurbase' ),
		'name_admin_bar'        => __( 'Authors', 'allurbase' ),
	...
	$args = array(
		'label'                 => __( 'Author', 'allurbase' ),
		'description'           => __( 'A person responsible for software', 'allurbase' ),
		'labels'                => $labels,
...
add_action( 'init', 'aub_create_author', 0 );
?>