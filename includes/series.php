<?php 
function aub_create_series() {

	$labels = array(
		'name'                  => _x( 'Series', 'Post Type General Name', 'allurbase' ),
		'singular_name'         => _x( 'Series', 'Post Type Singular Name', 'allurbase' ),
		'menu_name'             => __( 'Series', 'allurbase' ),
		'name_admin_bar'        => __( 'Series', 'allurbase' ),
	...
	$args = array(
		'label'                 => __( 'Series', 'allurbase' ),
		'description'           => __( 'A series of software releases', 'allurbase' ),
		'labels'                => $labels,
...
add_action( 'init', 'aub_create_series', 0 );
?>