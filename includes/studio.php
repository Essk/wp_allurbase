<?php 
function aub_create_studio() {

	$labels = array(
		'name'                  => _x( 'Studios', 'Post Type General Name', 'allurbase' ),
		'singular_name'         => _x( 'Studio', 'Post Type Singular Name', 'allurbase' ),
		'menu_name'             => __( 'Studios', 'allurbase' ),
		'name_admin_bar'        => __( 'Studios', 'allurbase' ),
	...
	$args = array(
		'label'                 => __( 'Studio', 'allurbase' ),
		'description'           => __( 'A software studio may have several authors, series or releases', 'allurbase' ),
		'labels'                => $labels,
...
add_action( 'init', 'aub_create_studio', 0 );
?>